...
| --- | --- | --- |
| Number of records | country_vaccinations.csv | 86,512 |
| Number of records | country_vaccinations_by_manufacturer.csv | 35,623 |
| Filesize | country_vaccinations.csv | 17.7 MB |
| Filesize | country_vaccinations_by_manufacturer.csv | 1.5 MB |
